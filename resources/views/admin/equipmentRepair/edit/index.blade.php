...
@section('titulo', 'Editar Reparação Equipamento ')
@section('content')
    ...
    <div class="card shadow">
        <div class="card-body">
            ...
            <div class="row align-items-center">
                ...
                <form class="col-lg-12 mt-2 col-md-12 col-12 mx-auto" method="POST" action="{{ route('admin.equipmentRepair.update', $equipmentRepair->id) }}">
                    @csrf
                    @method('PUT')
