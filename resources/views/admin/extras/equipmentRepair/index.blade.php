...
<script>
    ...
    const data = {
        ...
        datasets: [{
            ...
            data: [janEquipament, fevEquipament, marEquipament, abrEquipament, maioEquipament, junEquipament, julEquipament, agoEquipament, setEquipament, outEquipament, novEquipament, dezEquipament],
        }]
    };
