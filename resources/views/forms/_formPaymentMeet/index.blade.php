<div class="row mb-2">
    <div class="col-md-5">
        <div class="form-group">
            ...
            <select type="text" name="type" id="type" class="form-control border rounded" >
    ...
    <div class="col-md-4">
        <div class="form-group">
            <label for="type">Valores a Pagar </label>
...
<div class="row mb-2">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <select type="text" name="currency" id="currency" class="form-control border rounded" >
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <select type="text" name="status" id="status" class="form-control border rounded" >
