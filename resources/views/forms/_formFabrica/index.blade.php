    ...
    <div class="form-group">
        ...
        <select type="text" name="category" id="category" class="form-control border rounded" required>
          ...
          @if (isset($manufacture->category))
              <option value="{{ $manufacture->category }}" class="text-primary h6 bg-primary text-white" selected>
  ...
  <div class="col-md-12">
    <div class="form-group">
        <label for="file">Documentação </label>
          <input type="file" name="file" value="{{ isset($manufacture->file) ? $manufacture->file: old('file') }}" id="file" class="form-control border">
