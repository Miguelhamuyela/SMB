<div class="row">
  ...
  <div class="col-md-8">
    <div class="form-group">
        ...
        <input type="text" name="title" id="title" value="{{ isset($meetingRoom->title) ? $meetingRoom->title: old('title') }}"
...
<div class="col-md-4">
  <div class="form-group">
      ...
      <input type="text" name="phone" id="phone" value="{{ isset($meetingRoom->phone) ? $meetingRoom->phone: old('phone') }}"
...
<div class="col-md-5">
    <div class="form-group">
        ...
        <input type="text" name="name" id="name" value="{{ isset($meetingRoom->name) ? $meetingRoom->name: old('name') }}"
...
<div class="col-md-4">
  <div class="form-group">
      ...
      <input type="email" name="email" id="email" value="{{ isset($meetingRoom->email) ? $meetingRoom->email: old('email') }}"
      ...
      <label for="Sala">Sala <small class="text-danger">*</small></label>
          ...
          <select type="text" name="meetRoom" id="meetRoom" class="form-control border rounded" required>
            ...
            @if (isset($meetingRoom->meetRoom))
                <option value="{{ $meetingRoom->meetRoom }}"
